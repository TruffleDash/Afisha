...
ActiveRecord::Schema[7.1].define(version: 2023_11_22_103546) do
  ...
  create_table "concerts", charset: "latin1", force: :cascade do |t|
    t.string "title"
    t.string "body"
  ...
  create_table "tickets", charset: "latin1", force: :cascade do |t|
    t.string "zone"
    t.integer "seat"
    t.integer "price"
